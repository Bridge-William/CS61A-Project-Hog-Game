...
def boar_brawl(player_score, opponent_score):
    ...
    value = 3 * abs(player_score - opponent_score)
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    nums_of_factors = num_factors(score)
    if nums_of_factors == 3 or nums_of_factors == 4:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(goal):
        for opponent_score in range(goal):
            if strategy(socre, opponent_score) != strategy(0, 0):
                return False
    return True
    # END PROBLEM 7
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    #return num_rolls  # Remove this line once implemented.
    if sus_points(simple_update(0, score, opponent_score)) - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
